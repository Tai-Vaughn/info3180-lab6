...
const NewsList = Vue.component('news-list',{
    template: `
      <div class="news">
        ...
        <ul class="news__list row " type ='none' >
    ...
    created: function() {
      let self = this;
      fetch('https://newsapi.org/v2/top-headlines?country=us&apiKey=<key was here>')
    ...
    methods: {
      searchNews: function() {
        let self = this;
        fetch('https://newsapi.org/v2/everything?q='+ self.searchTerm + '&language=en&apiKey=<key was here>')
        .then(function(response) {return response.json();})
        .then(function(data) {self.articles = data.articles;
        });
      }
